...
while1:
	...
	bl mod					// call to mod
	mov r4, #0				//set up the next add function
	add r4, r7, r0, lsl #2	// r0 is the random number that gets multiplied by 4 for the bytes 
	ldr r0, [r4]			//add the value of r0 to the sp
...
while2:	
	...
	bge end3
	add r4, r7, r9, lsl #2	//add r9 which is i which was multiplied by 4 to the sp
	ldr r0, [r4]			//load the value at index i
